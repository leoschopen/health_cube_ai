...
def split_4d(input_folder,
    ...
    #     shutil.rmtree(output_folder) #将outputfolder下的内容删除
    # shutil.copytree(
    #     join_paths(input_folder, train_labels_dir),
    #     join_paths(output_folder, train_labels_dir)) #将trainlabel复制到output下的trainlabel下
    # shutil.copy(join_paths(input_folder, data_json), output_folder) #复制dataset.json到output下

    files = []
    output_dirs = []
    os.makedirs(output_folder, exist_ok=True)
    subdir = test_images_dir
